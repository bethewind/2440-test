...
extern void rLB_ReadPage(unsigned int addr, unsigned char * to) ;//这段程序用于，Nand Flash每页大小是2048个字节
extern void NF_WritePage(unsigned int page, unsigned char *buffer) ;
