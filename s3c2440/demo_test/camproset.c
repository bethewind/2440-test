...
{
	save_GPECON = rGPECON;
	rGPECON =(( rGPECON) & ~((unsigned int)(0xf)<<28)) |( (unsigned int)(0xa)<<28);	//GPE15:IICSDA , GPE14:IICSCL 	 
}
...
{
	unsigned int RegAddr, RegData, pageNo;//i, j, save_E, save_PE, 
...
{
	unsigned int RegAddr,pageNo;//i, j, save_E, save_PE,  RegData, 
	static U8 rdata[8];
