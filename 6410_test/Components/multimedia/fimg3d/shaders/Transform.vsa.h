#if !defined(__TRANSFORM_VSA_H__)
#define __TRANSFORM_VSA_H__

static const unsigned Transform_vsa[] = {
  // ---------------------------------------------
  ...
  0x00000000, 0x00020000, 0x00f803e4, 0x00000000,
  0x00000000, 0x00000000, 0x1e000000, 0x00000000,
  // ---------------------------------------------
  // Constant Float Registers (0 ~ 255)
  // - x , y , z , w
  // ---------------------------------------------
  0x3fddb3d9, 0x00000000, 0x00000000, 0x00000000,
  0x00000000, 0x3fddb3d9, 0x00000000, 0x00000000,
  0x00000000, 0x00000000, 0xbf80419a, 0x3fcd3c4f,
  0x00000000, 0x00000000, 0xbf800000, 0x3fe66666,
};

#endif /*__TRANSFORM_VSA_H__*/
