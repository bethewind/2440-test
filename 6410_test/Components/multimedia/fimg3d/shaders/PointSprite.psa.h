#if !defined(__POINTSPRITE_PSA_H__)
#define __POINTSPRITE_PSA_H__

static const unsigned PointSprite_psa[] = {
  // ---------------------------------------------
  ...
  0x00000000, 0x0000a401, 0x037810e4, 0x00000000,
};

#endif /*__POINTSPRITE_PSA_H__*/
