#if !defined(__DISPLACEMENT_PSA_H__)
#define __DISPLACEMENT_PSA_H__

static const unsigned UART_Printflacement_psa[] = {
  // ---------------------------------------------
  ...
  0x00000000, 0x0100e400, 0x037810e4, 0x00000000,
  0x00000000, 0x00000000, 0x1e000000, 0x00000000,
};

#endif /*__DISPLACEMENT_PSA_H__*/
