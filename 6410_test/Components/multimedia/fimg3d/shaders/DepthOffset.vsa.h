#if !defined(__DEPTHOFFSET_VSA_H__)
#define __DEPTHOFFSET_VSA_H__

static const unsigned DepthOffset_vsa[] = {
  // ---------------------------------------------
  ...
  0x00000000, 0x02040000, 0x00f801e4, 0x00000000,
  // ---------------------------------------------
